    ...
    <main className="w-full pb-20 pt-10 bg-[#f7f9fb] min-h-screen flex flex-col">
      ...
      <section className="relative max-w-7xl mx-auto px-6 md:px-12 py-12 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          {/* Animasi teks muncul lebih dulu */}
          ...
          {/* Animasi gambar menyusul dengan delay 0.3 */}
          <ScrollReveal delay={0.3} direction="up">
            <div className="relative h-100 md:h-125 rounded-3xl overflow-hidden shadow-2xl border border-gray-100 hover:shadow-cyan-500/20 transition-shadow duration-500">
              <img 
      ...
      {/* 2. STATS SECTION (Dengan Staggered Animation) */}
      <section className="bg-white py-12 border-y border-gray-200/60 overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-20 space-y-12 overflow-hidden">
        <ScrollReveal delay={0.1} direction="up">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <ScrollReveal delay={0.2} direction="up" className="lg:col-span-7 bg-white border border-gray-100 rounded-3xl p-8 md:p-10 shadow-sm hover:shadow-lg transition-all duration-300">
            ...
            <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-linear-to-b before:from-cyan-300 before:via-gray-200 before:to-transparent">
              ...
              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group hover:-translate-y-1 transition-transform">
                ...
                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-5 bg-gray-50 rounded-2xl border border-gray-100 group-hover:border-cyan-200 transition-colors">
              ...
              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group hover:-translate-y-1 transition-transform">
                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 text-black font-bold shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 border-4 border-white group-hover:bg-cyan-100 group-hover:text-cyan-800 transition-colors">2</div>
                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-5 bg-gray-50 rounded-2xl border border-gray-100 group-hover:border-cyan-200 transition-colors">
              ...
              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group hover:-translate-y-1 transition-transform">
                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 text-black font-bold shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 border-4 border-white group-hover:bg-cyan-100 group-hover:text-cyan-800 transition-colors">3</div>
                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-5 bg-gray-50 rounded-2xl border border-gray-100 group-hover:border-cyan-200 transition-colors">
              ...
              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group hover:-translate-y-1 transition-transform">
                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 text-black font-bold shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 border-4 border-white group-hover:bg-cyan-100 group-hover:text-cyan-800 transition-colors">4</div>
                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-5 bg-gray-50 rounded-2xl border border-gray-100 group-hover:border-cyan-200 transition-colors">
          ...
          <ScrollReveal delay={0.4} direction="up" className="lg:col-span-5 bg-black text-white rounded-3xl p-8 md:p-10 shadow-xl flex flex-col hover:-translate-y-1 transition-transform duration-300">
            ...
            <ul className="space-y-4 grow font-body text-gray-300 text-sm">
              <li className="flex items-start group">
                <span className="material-symbols-outlined text-amber-400 mr-3 mt-0.5 text-xl group-hover:scale-125 transition-transform">check_circle</span>
                <span className="group-hover:text-white transition-colors">Fotokopi Ijazah SD/MI yang dilegalisir (1 lembar)</span>
              </li>
              <li className="flex items-start group">
                <span className="material-symbols-outlined text-amber-400 mr-3 mt-0.5 text-xl group-hover:scale-125 transition-transform">check_circle</span>
                <span className="group-hover:text-white transition-colors">Fotokopi Surat Keterangan Lulus (1 lembar)</span>
              </li>
              <li className="flex items-start group">
                <span className="material-symbols-outlined text-amber-400 mr-3 mt-0.5 text-xl group-hover:scale-125 transition-transform">check_circle</span>
                <span className="group-hover:text-white transition-colors">Fotokopi Akta Kelahiran (1 lembar)</span>
              </li>
              <li className="flex items-start group">
                <span className="material-symbols-outlined text-amber-400 mr-3 mt-0.5 text-xl group-hover:scale-125 transition-transform">check_circle</span>
                <span className="group-hover:text-white transition-colors">Fotokopi Kartu Keluarga (KK) (1 lembar)</span>
              </li>
              <li className="flex items-start group">
                <span className="material-symbols-outlined text-amber-400 mr-3 mt-0.5 text-xl group-hover:scale-125 transition-transform">check_circle</span>
                <span className="group-hover:text-white transition-colors">Pas Foto berwarna ukuran 3x4 (2 lembar)</span>
              </li>
              <li className="flex items-start group">
                <span className="material-symbols-outlined text-amber-400 mr-3 mt-0.5 text-xl group-hover:scale-125 transition-transform">check_circle</span>
                <span className="group-hover:text-white transition-colors">Surat Keterangan Berkelakuan Baik dari sekolah asal</span>
              </li>
              <li className="flex items-start group">
                <span className="material-symbols-outlined text-amber-400 mr-3 mt-0.5 text-xl group-hover:scale-125 transition-transform">check_circle</span>
                <span className="group-hover:text-white transition-colors">Fotokopi KTP Orang Tua (1 lembar)</span>
              </li>
              <li className="flex items-start group">
                <span className="material-symbols-outlined text-amber-400 mr-3 mt-0.5 text-xl group-hover:scale-125 transition-transform">check_circle</span>
                <span className="group-hover:text-white transition-colors">Fotokopi Raport (1 rangkap)</span>
              </li>
              <li className="flex items-start group">
                <span className="material-symbols-outlined text-amber-400 mr-3 mt-0.5 text-xl group-hover:scale-125 transition-transform">check_circle</span>
                <span className="group-hover:text-white transition-colors">Fotokopi KIP/PKH/KKS (1 lembar)</span>
              </li>
              <li className="flex items-start group">
                <span className="material-symbols-outlined text-amber-400 mr-3 mt-0.5 text-xl group-hover:scale-125 transition-transform">check_circle</span>
                <span className="group-hover:text-white transition-colors">Formulir Pendaftaran (1 berkas)</span>
              </li>
            </ul>
      ...
      <section id="biaya" className="bg-white py-20 border-t border-gray-200/60 mt-auto overflow-hidden">
        <ScrollReveal delay={0.2} direction="up">
          <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
            
            <div className="mx-auto w-16 h-16 rounded-full bg-cyan-100 text-cyan-800 flex items-center justify-center mb-6 hover:scale-110 transition-transform duration-300">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="/brosur-spmb.pdf" download className="w-full sm:w-auto inline-flex items-center justify-center bg-white border-2 border-gray-200 text-black font-mono text-xs font-bold px-8 py-4 rounded-xl hover:bg-gray-50 hover:border-black transition-all duration-300 shadow-sm gap-2.5 group">
                <span className="material-symbols-outlined text-[20px] leading-none group-hover:-translate-y-1 transition-transform">download</span>
