...
import {
  LimitsModal,
  useReviewWorkflows
} from "./chunk-ROHCCQVV.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-DSHKWBWD.js";
import {
  getStageColorByHex
} from "./chunk-AZSGD7DL.js";
import {
...
} from "./chunk-3VASCVQP.js";
import {
  useTypedSelector
} from "./chunk-4JYNDOFJ.js";
import {
  ReleaseActionMenu,
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-CCP4YZ5J.js";
import {
  useConfig
} from "./chunk-7EF5OO5X.js";
import {
  Drawer,
  abortUpload,
  cancelUpload,
...
import {
  useAdminUsers
} from "./chunk-FLQVGOHE.js";
import {
  useAIAvailability
} from "./chunk-722DWJFI.js";
import {
  useLicenseLimits
} from "./chunk-XLQ3XZEJ.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3,
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-ZT3I6TRK.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
var admin = {
  ...
  register(app) {
    app.addSettingsLink({
      ...
      id: "settings",
      to: "email",
      Component: () => import("./Settings-WKM5BCXV.js").then((mod) => ({
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-H3HEKFOZ.js");
    case "./translations/es.json":
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-G3DKBOFJ.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-RYNTITIZ.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      Component() {
        return import("./SettingsPage-3V7HSBUB.js").then((mod) => ({
          default: mod.ProtectedSettingsPage
        }));
      },
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-AGIYWDH6.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-RQVYK34E.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./ReleasesSettingsPage-CZAOYHXI.js").then((mod) => ({
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-YFEOJEGS.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./PurchaseContentReleases-BKTSCUFY.js").then((mod) => ({
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./router-TNBZ2GQO.js").then((mod) => ({
            default: mod.Router
          }));
        }
      });
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-2X3GSCSA.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./purchase-review-workflows-HQWTJUX6.js").then((mod) => ({
...
//# sourceMappingURL=chunk-ICPGDUEL.js.map
