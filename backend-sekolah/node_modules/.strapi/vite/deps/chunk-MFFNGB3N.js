import {
  ...
  HOOKS
} from "./chunk-FYKPDEIK.js";
import {
  useNpsSurveySettings
} from "./chunk-EXLOD2DR.js";
import {
  require_pick
} from "./chunk-SWJPVGRX.js";
import {
  getBasename
...
import {
  ...
  getEERoutes
} from "./chunk-Q4QJ7WFH.js";
import {
  Login
} from "./chunk-FTBB5FCY.js";
import {
  MemoizedInputRenderer
} from "./chunk-FOHOG2QK.js";
import {
  Form
} from "./chunk-QKHKUBEB.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-VR3W3RQQ.js";
import {
  ConfigurationProvider
} from "./chunk-QXNWX4PZ.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-DGSZFNJX.js";
import {
  require_baseRest
} from "./chunk-2IQYDYRS.js";
import {
  HistoryProvider
} from "./chunk-3IKSFAP4.js";
import {
  useClipboard
} from "./chunk-5SIU7YEP.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-722DWJFI.js";
import {
  useGetAiUsageQuery
} from "./chunk-LTYDHUWY.js";
import {
  _setPrototypeOf
} from "./chunk-MBK4V2X7.js";
import {
  useEnterprise
} from "./chunk-PABXXBQN.js";
import {
  Layouts
} from "./chunk-3YFHWVUT.js";
import {
  errorsTrads
...
import {
  ...
  TrackingProvider,
  useTracking
} from "./chunk-AR2NRE3F.js";
import {
  require_isEqual
} from "./chunk-GW6RXFII.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-SYIUTB7T.js";
import {
  Page,
  l1,
  useAPIErrorHandler
} from "./chunk-VE6PXOIY.js";
import {
  AuthProvider,
  StrapiAppProvider,
  getOrCreateDeviceId,
  ...
  useTypedSelector,
  useTypedStore
} from "./chunk-K4STSBDG.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-KEASQFGD.js";
import {
...
import {
  ...
  require_root,
  require_setToArray
} from "./chunk-7PRAQQYX.js";
import {
  provider_default,
  useIntl
} from "./chunk-PL233N3N.js";
import {
  require_client
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-5A5XKRLL.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-RM7X7L3P.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-A7WCQHE4.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-6QCPPWO2.js")).FORMS, {
...
var ADMIN_TOKEN_ROUTES = [
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-LWD6I6AH.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-3KTRCR45.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-F5NZ376G.js");
      return {
...
var ROUTES_CE = () => [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-ZKGWOQYW.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-5FR7XY6L.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-3ENAP4NX.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-ENXIRN3T.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-SS6SQZPX.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-Z6IQCKH4.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-5I5AWMWU.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-4PXKFLB7.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-OQAM53EG.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-PWTMWAEJ.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-ZII23RDD.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-M3LICL7A.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-H3MVGVHU.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-I7MNOHZW.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-NWFZZKGY.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-LJDO7OED.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-CJ2FRTAS.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-D4AZEPBA.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-ASU4ZBJ5.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-5EF7NWGV.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-JROST3OY.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-5G2CFIWO.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-RG6YDPKF.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-NQ5QCKCE.js");
              return {
...
function __variableDynamicImportRuntime5__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-JBGIP2YD.js");
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-BE7EWV6H.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-DTAAXJIB.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-DTAAXJIB.js");
      ...
      },
      {
        ...
        component: async () => {
          const { DeployNowWidget } = await import("./Widgets-DTAAXJIB.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-DRPH7D3Z.js");
...
//# sourceMappingURL=chunk-MFFNGB3N.js.map
